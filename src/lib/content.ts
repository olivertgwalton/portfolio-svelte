...
const filesByType: Record<ContentType, Record<string, unknown>> = {
	blogs: import.meta.glob("/src/lib/blogs/**/index.md", {
		eager: true,
		import: "metadata",
	}),
	projects: import.meta.glob("/src/lib/projects/**/index.md", {
		eager: true,
		import: "metadata",
	}),
	experience: import.meta.glob("/src/lib/experience/*.md", {
		eager: true,
		import: "metadata",
	}),
	education: import.meta.glob("/src/lib/education/*.md", {
		eager: true,
		import: "metadata",
	}),
...
export function getRelatedContent(
	...
	return all
		...
		.map((item) => {
			const overlap = getItemTags(item).filter((t) =>
